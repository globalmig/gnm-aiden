...
export default function Toast({ vaild, setVaild, onConfirm }: ToastProps) {
    return (
        <>
            {vaild && (
                <div className="bg-white rounded-2xl fixed top-1/2 left-1/2 z-100 w-[90%] max-w-sm -translate-x-1/2 -translate-y-1/2">
                    <div className="px-6 pt-6 pb-5">
                        ...
                        {onConfirm ? (
                            ...
                            <div className="pt-5 text-center">
                                <button onClick={() => setVaild(null)} className="admin-btn-primary px-8">
                                    확인
                                </button>
                            </div>
                        )}
            ...
            {vaild && <div className="black-bg z-50" />}
        </>
    );
}
